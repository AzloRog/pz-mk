  ...
  return (
    <article className="homepage__menu-preview flex-container flex-column">
      <section className="menu-preview__info txt-center">
        <h2 className="pop-font txt-white">Горячая пицца</h2>
        <p className="section-description">
          Pizza Maker удерживает рынок индустрии пиццы и постоянно предлагает
          больше, чем просто пиццу. Ознакомьтесь с нашими самыми горячими
          вариантами меню с сыром, мясом, курицей и овощами!
        </p>
      </section>
