...
const MenuPricingPreview = () => {
  return (
    ...
    >
      <h2 className="txt-center pop-font txt-white">Цены</h2>
      <p className="section-description">
        Каждый кусочек каждого блюда особенный. Ты никогда не получишь серость и
        ты всегда сможешь найти что-то новое и интересное для себя. Откройте для
        себя все аппетитные варианты, которые у нас есть в предложении
      </p>
